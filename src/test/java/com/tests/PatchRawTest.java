...
public class PatchRawTest {
    ...
    public void testPatchRequest() {
        ...
        Assert.assertTrue(contentType.contains("text/plain"),
                "content-type должен содержать 'text/plain', но содержит: " + contentType);
        ...
        Assert.assertEquals(url, "https://postman-echo.com/patch", "URL в ответе не совпадает");
